...
# --- Categories & thresholds (see docs/shared_understanding_thresholds.md) ---
...
class SharedUnderstandingModel:
    ...
    # ---- coverage helpers (used by Clarification Engine & Open Questions) ----
...
if __name__ == "__main__":
    # Quick manual smoke test — no AWS/Kiro needed.
